...
var ABTest = require("../dist/modest-abtest.cjs.min.js");
    ...
    var abtest = new ABTest("abtestAppSymbol", [
      {
        ...
        exp_set: [
          ...
          { id: 3, weight: 0.1, data: "planC" },
          { id: 4, weight: 0.1, data: "planD" },
        ],
      },
    ]);
      ...
      layer: {
        layerSymbol: {
          ...
          exp_set: {
            ...
            3: {
              data: "planC",
              bucket: [80, 81, 82, 83, 84, 85, 86, 87, 88, 89],
              version: 1,
            },
            4: {
              data: "planD",
              bucket: [90, 91, 92, 93, 94, 95, 96, 97, 98, 99],
              version: 1,
            },
          },
        },
